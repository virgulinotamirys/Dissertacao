...
public class HapticPlugin : MonoBehaviour
{
    ...
    [Range(0.0f, 1.0f)] public float PhysicsForceStrength = 0.5f; //!< Spring force coupling the haptic forces and the Unity Physics simualtion
    [Range(0.0f, 1.0f)] public float PhysicsForceDamping = 0.5f; //!< Damping force for the spring coupling the haptic forces and the Unity Physics simulation.
